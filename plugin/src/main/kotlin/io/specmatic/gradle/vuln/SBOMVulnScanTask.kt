...
internal fun Project.createSBOMVulnScanTask() {
    ...
    val scanTask = tasks.register("${scanTaskName}Scan", SBOMVulnScanTask::class.java) {
        ...
        reportsDir.set(project.layout.buildDirectory.get().asFile.resolve("reports/vulnerabilities/sbom"))
    }
